...
sed -i "s/ENABLE_PROPOSER=false/ENABLE_PROPOSER=true/g" .env


sed -i "s/L1_PROVER_PRIVATE_KEY=/L1_PROVER_PRIVATE_KEY=$PRIVATE_KEY/g" .env
sed -i "s/L1_PROPOSER_PRIVATE_KEY=/L1_PROPOSER_PRIVATE_KEY=$PRIVATE_KEY/g" .env
...
sed -i "s/L2_SUGGESTED_FEE_RECIPIENT=|L2_SUGGESTED_FEE_RECIPIENT=$FEE_ADDRESS|g" .env
